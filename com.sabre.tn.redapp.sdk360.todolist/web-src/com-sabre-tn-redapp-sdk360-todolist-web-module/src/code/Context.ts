...
/** @internal **/
export const context: IModuleContext = new ModuleContext("com-sabre-tn-redapp-sdk360-todolist-web-module");
/** @internal **/
...
/** @internal **/
export const t: ScopedTranslator = getService(I18nService).getScopedTranslator('com-sabre-tn-redapp-sdk360-todolist-web-module/translations');
